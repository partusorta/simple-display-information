...
class RecedePage extends StatefulWidget {
  final Loopimage loopimage;
  final AllProcess allProcess;
  RecedePage({@required this.loopimage, this.allProcess});
  @override
  State<StatefulWidget> createState() {
    return new RecedePageState();
  }
}

class RecedePageState extends State<RecedePage> {
  List imageData;
  List processData;
  var more = 0;
